...
The evaluator-visible artifact is published in the existing
[Hugging Face Space](https://huggingface.co/spaces/DineshAI/SOlPHMdSY3/tree/beea5e8b4af3e149d85796bd4922b6d03339a6ac)
...
Read the [illustrated technical report](reports/reproduction/report.md), the
[final release report](reports/reproduction/release_report.md), or the
...
| [candidate-space-and-release-gates](https://github.com/MachineLearning-Nerd/icml26-repro-SOlPHMdSY3-finite-width-neural-tangent-kernels-from-feynman-diagrams/tree/orx/candidate-space-and-release-gates) | Fresh evaluator traversal, manifest, historical-subset, secret, image, and notebook gates | `uv sync --frozen --all-extras && uv run --frozen python -m reproduction.run_all` | Claims 1–5 VERIFIED; all release gates pass; published to existing Space | HF cpu-upgrade, 8 CPU quota, no GPU; 5,095.131 s scientific runtime |
